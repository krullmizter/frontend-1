...
function dueDate() {
    ...
    if (WHOLEDATE < CURRENTDATE) {
        ...
        if (WEEKDAY == 6) {
            ...
            var finalDate = (date + 2) + '.' + (WHOLEDATE.getMonth() +1) + '.' + WHOLEDATE.getFullYear();
    
        } else if (WEEKDAY == 0) {
    
            var finalDate = (date + 1) + '.' + (WHOLEDATE.getMonth() +1) + '.' + WHOLEDATE.getFullYear();
    
        } else {
    
            var finalDate = date + '.' + (WHOLEDATE.getMonth() +1) + '.' + WHOLEDATE.getFullYear();
